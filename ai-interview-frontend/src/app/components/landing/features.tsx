      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <motion.div
            ...
            className="group relative rounded-xl bg-neutral-900/50 backdrop-blur-sm border border-white/10 p-6 hover:border-[#cbe557]/30 hover:-translate-y-1 transition-all duration-300"
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 rounded-lg bg-neutral-800 border border-white/5">
                <Terminal className="w-4 h-4 text-[#cbe557]" />
              </div>
              <h3 className="text-sm font-semibold text-white">Live Sandbox</h3>
            </div>

            <p className="text-neutral-400 text-xs leading-relaxed mb-4">
              Execute Python and C++ in isolated containers with real-time
              output streaming.
            </p>
            ...
            <div className="mt-4 flex items-center gap-1 text-xs text-neutral-500 group-hover:text-[#cbe557] transition-colors">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 rounded-lg bg-neutral-800 border border-white/5">
                <Camera className="w-4 h-4 text-[#cbe557]" />
              </div>
            ...
            <p className="text-neutral-400 text-xs leading-relaxed mb-4">
              YOLOv8 and DeepFace integration for identity verification and
              behavioral analysis.
            </p>

            {/* Camera Feed Wireframe */}
            <div className="rounded-lg bg-neutral-950 border border-white/5 overflow-hidden aspect-video relative">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 rounded-lg bg-neutral-800 border border-white/5">
                <FileText className="w-4 h-4 text-[#cbe557]" />
              </div>
              <h3 className="text-sm font-semibold text-white">Deep Resumes</h3>
            </div>

            <p className="text-neutral-400 text-xs leading-relaxed mb-4">
              PDF parsing with structured extraction for personalized technical
              deep-dives.
            </p>

            {/* JSON Tree Wireframe */}
            <div className="rounded-lg bg-neutral-950 border border-white/5 p-3 font-mono text-[10px]">
